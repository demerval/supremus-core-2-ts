...
var UsuarioModel = /** @class */ (function (_super) {
    ...
    function UsuarioModel() {
        return _super.call(this, 'usuario', 'usuarios', campos, 1) || this;
    }
    UsuarioModel.prototype.onEstruturaVerificada = function (dao) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.ModelUpdateVersao.getModelVersao(dao, 'usuario')];
                    case 1:
                        model = _a.sent();
                        model.versaoUpdate = 1;
                        return [4 /*yield*/, index_1.ModelUpdateVersao.atualizarVersao(dao, model)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
