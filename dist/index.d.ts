...
export declare const SupremusCore: {
    ...
    modelPersiste(config: import("./src/model/ModelPersite").ConfigPersist, dao: DAOI): Promise<Record<string, any>>;
    modelConsultar(config: import("./src/sql/SqlConsulta").ItemConsulta | import("./src/sql/SqlConsulta").ItemConsulta[], dao: DAOI): Promise<Record<string, any> | undefined>;
};
