...
export declare const SupremusCore: {
    ...
    modelConsultar(config: import("./src/sql/SqlConsulta").ItemConsulta | import("./src/sql/SqlConsulta").ItemConsulta[], dao?: DAOI | undefined): Promise<Record<string, any>[]>;
    modelConsultarArray(config: import("./src/sql/SqlConsulta").ItemConsulta | import("./src/sql/SqlConsulta").ItemConsulta[], dao?: DAOI | undefined): Promise<Record<string, any>>;
