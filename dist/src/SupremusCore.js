...
var SupremusCore = {
    carregarModels: function (dirModels) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new CarregarModelsUtil_1.default().verificarPastas(dirModels)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, new EstruturaVerificar_1.default().verificar()];
                    case 2:
                        _a.sent();
    ...
    getModel: function (nome) {
        return ModelManager_1.default.getModel(nome.toLowerCase());
    },
    modelPersiste: function (config, dao) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    modelConsultar: function (config, dao) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
